...
public class Basicos {
	...
	public static void main(String[] args) {
		...
		System.out.println("Valor num�rico del car�cter C " + C + " = " + (int)C);
...
//		Escribe un programa Java que declare una variable entera Z y as�gnale un valor. A continuaci�n escribe las instrucciones que realicen los siguientes:
//		Incrementar Z en 77.
//		Decrementarla en 3.
//		Duplicar su valor.
